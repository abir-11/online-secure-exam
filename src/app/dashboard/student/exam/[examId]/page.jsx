  ...
  useEffect(() => {
    ...
    timerRef.current = setInterval(() => {
      setTimeLeft((prev) => {
        ...
        if (prev <= 300)
          setWarningMessage(`CRITICAL: ${formatTime(prev)} REMAINING!`);
        return prev - 1;
      });
    }, 1000);
    return () => clearInterval(timerRef.current);
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-emerald-950 flex flex-col items-center justify-center">
        ...
        <p className="text-emerald-400 font-black tracking-widest text-xs uppercase animate-pulse">
          Syncing Exam Paper...
        </p>
      </div>
    );
    ...
    <main className="min-h-screen bg-emerald-950 text-emerald-50 select-none pb-24">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-[10px] text-emerald-500/60 font-bold tracking-[0.2em]">
                PROTECTED SESSION
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div
              className={`flex items-center gap-3 px-6 py-2 rounded-2xl border-2 transition-all shadow-lg ${timeLeft < 300 ? "bg-rose-500/10 border-rose-500 text-rose-500 animate-pulse" : "bg-emerald-900/50 border-emerald-500/30 text-emerald-400"}`}
            >
              <Clock size={18} />
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 pt-10">
        ...
        <AnimatePresence>
          {warningMessage && (
            <motion.div
              ...
              className="mb-8 bg-rose-600 text-white p-4 rounded-2xl flex items-center gap-3 shadow-2xl shadow-rose-900/40 border border-rose-400/30"
            >
          ...
          {questions.map((q, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <HelpCircle
                  className="text-emerald-800 group-hover:text-emerald-500 transition-colors"
                  size={20}
                />
              </div>
              ...
              {exam.type === "mcq" ? (
                <div className="grid grid-cols-1 gap-4">
                  {q.options.map((opt, idx) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-6 h-6 rounded-full border-2 mr-5 flex items-center justify-center shrink-0 transition-all
                        ...
                        {isSelected && (
                          <ChevronRight className="absolute right-6 text-emerald-950" />
                        )}
                      </button>
                    );
                  })}
                ...
                <div className="relative">
                  <FileText
                    className="absolute top-6 left-6 text-emerald-500/20"
                    size={24}
                  />
                  <textarea
                    rows={8}
        ...
        <footer className="mt-20 mb-32 flex flex-col items-center">
          ...
          <p className="mt-6 text-[10px] font-bold text-emerald-800 uppercase tracking-[0.4em]">
