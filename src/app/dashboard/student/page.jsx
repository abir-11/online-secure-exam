    ...
    <main className="min-h-screen bg-emerald-950 text-emerald-50 pb-24 pt-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-emerald-100/40 font-medium text-lg mt-2">Review your scores and performance milestones.</p>
        </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                  <div className="flex-1 space-y-3">
                    ...
                    <h2 className="text-2xl font-black text-white tracking-tight">
                      Exam ID: <span className="text-emerald-500/60 font-mono text-xl uppercase">{r.examId.slice(-8)}</span>
                    </h2>
                  ...
                  {/* Score Display Box */}
                  <div className="flex items-center gap-8 bg-emerald-950/60 p-6 rounded-[2rem] border border-emerald-500/10 min-w-[220px] justify-center group-hover:border-emerald-500/30 transition-all shadow-inner">
                    <div className="text-center">
                      <p className="text-[10px] font-black text-emerald-500/50 uppercase tracking-widest mb-1">Final Score</p>
                      <p className="text-3xl font-black text-white leading-none">
                        {r.score}
                        <span className="text-emerald-500/30 text-lg ml-1 font-medium">/ {r.totalMarks}</span>
                      </p>
                    </div>
                    
                    <div className="w-12 h-12 bg-emerald-500 rounded-2xl flex items-center justify-center text-emerald-950 shadow-lg shadow-emerald-500/20 group-hover:scale-110 group-hover:rotate-6 transition-all">
                      <Trophy size={24} />
                    </div>
                  </div>
                </div>
      ...
      <div className="mt-20 flex justify-center opacity-20">
        <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.5em] text-emerald-500">
           Academic Integrity <Target size={12} /> Verified
        </div>
      </div>
    </main>
  );
