          ...
          >
            ...
            <div className="flex items-center mt-2 text-emerald-600/70">
              ...
              <p className="text-xs font-bold uppercase tracking-[0.2em]">
                Secure Exam Environment Active
              </p>
            </div>
          </motion.div>
        ...
        <AnimatePresence mode="wait">
          {!submitted ? (
            ...
            >
              ...
              <div className="bg-emerald-900 text-emerald-50 p-6 rounded-3xl shadow-xl shadow-emerald-900/10 flex items-center gap-4">
                ...
                <p className="text-sm font-medium leading-relaxed opacity-90">
                  Welcome! This is a demo mode. Test your knowledge and get
                  familiar with the interface.{" "}
                  <strong>
                    Selection, Copying, and Right-click are disabled.
                  </strong>
                </p>
              </div>
                      ...
                      {q.options.map((option, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span
                              className={`text-lg ${isSelected ? "font-bold text-emerald-900" : "text-gray-700"}`}
                            >
                              {option}
                            </span>
                          </button>
              ...
              <div className="flex justify-center pb-20">
                <button
                  ...
                  disabled={
                    Object.keys(answers).length !== DEMO_QUESTIONS.length
                  }
            ...
            >
              ...
              <p className="text-emerald-600 font-bold uppercase tracking-widest text-xs mb-8">
              ...
              <div className="flex flex-col items-center mb-10">
                ...
                <div className="w-full max-w-sm h-3 bg-gray-100 rounded-full overflow-hidden border border-gray-100">
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{
                      width: `${(score / DEMO_QUESTIONS.length) * 100}%`,
                    }}
