...
//       <h1 className="text-3xl font-bold mb-6 text-teal-800">Notifications</h1>

//       {messages.length === 0 ? (
//         <div className="p-6 bg-teal-50 border-l-4 border-teal-400 text-teal-800 rounded shadow-md">
...
//             <li
//               key={msg._id}
//               className="bg-white p-4 rounded-xl shadow hover:shadow-lg transition-shadow duration-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-4 border-l-4 border-teal-300"
//             >
