...
export default function PaymentHistoryPage() {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-emerald-950 flex flex-col items-center justify-center text-emerald-400">
        ...
        <p className="font-black tracking-widest text-xs uppercase animate-pulse">
  ...
  return (
    <main className="min-h-screen bg-emerald-950 text-emerald-50 pb-24 pt-20 relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          {payments.length > 0 && (
            ...
            >
              <div className="flex flex-col">
                <span className="text-emerald-500/60 text-[10px] font-black uppercase tracking-widest">
                  Total Investment
                </span>
        ...
        {payments.length === 0 ? (
          ...
          >
            ...
            <p className="text-emerald-600 font-black uppercase tracking-widest text-sm">
              No transactions found
            </p>
          </motion.div>
        ) : (
          <div className="bg-emerald-900/10 rounded-[2.5rem] overflow-hidden backdrop-blur-xl shadow-2xl">
...
function StatusBadge({ status }) {
  ...
  return (
    <div
      className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full border text-[10px] font-black uppercase tracking-widest ${config.classes}`}
    >
      {config.icon}
      {status}
    </div>
