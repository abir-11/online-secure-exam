          ...
          {batches.map((batch) => (
            <div
              ...
              className={`p-4 md:p-5 hover:bg-gray-50 transition-all cursor-pointer ${
                selectedBatch === batch.id ? "bg-[#0D7C66]/5" : ""
              }`}
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <Layers className="w-5 h-5 text-[#0D7C66]" />
                ...
                <tbody className="divide-y">
                  {batchDetail.studentPerformance?.map((student, i) => (
                    <tr key={i} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getScoreBgColor(student.avgPercentage)} ${getScoreColor(student.avgPercentage)}`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getScoreBgColor(student.passRate)} ${getScoreColor(student.passRate)}`}
                        >
                          {student.passRate}%
                        </span>
                      </td>
