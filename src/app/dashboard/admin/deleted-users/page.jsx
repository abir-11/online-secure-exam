    ...
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4 md:p-6">
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-400 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 mb-4 sm:mb-6 text-white">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
          ...
          <Link
            href="/dashboard/admin/users"
            className="bg-white text-red-500 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl hover:bg-gray-100 transition flex items-center gap-1 sm:gap-2 shadow-lg text-sm sm:text-base"
          >
                ...
                <tbody className="divide-y divide-gray-200">
                  {users.map((user) => (
                    <tr key={user._id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-4 sm:px-6 py-3 sm:py-4">
                        <span className="px-2 sm:px-3 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 border border-red-200">
                          Deleted
                        </span>
                      </td>
                      <td className="px-4 sm:px-6 py-3 sm:py-4">
                ...
                <div key={user._id} className="p-3 sm:p-4 hover:bg-gray-50">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 flex items-center gap-1 mt-0.5 break-all">
                        <Mail className="w-3 h-3" />
                        {user.email}
                      </p>
                    </div>
