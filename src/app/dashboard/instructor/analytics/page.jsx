...
// //               <button
// //                 className="mt-4 flex items-center gap-2 bg-teal-600 hover:bg-indigo-700 text-white px-3 py-1 rounded-md"
...
// dashboard/instructor/analytics/page.jsx version 3
//dashboard/instructor/analytics/page.jsx
"use client";
