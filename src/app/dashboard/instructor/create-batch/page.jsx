      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-lg">
        ...
        <ul className="space-y-3">
          {batches.map((b) => (
            <li
              key={b._id}
              className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gray-100 dark:bg-gray-800 p-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-200"
            >
              <span className="text-gray-800 dark:text-gray-100 font-medium mb-2 sm:mb-0">
                {b.name}
              </span>
