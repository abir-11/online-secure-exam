    ...
    <div className="mt-8">
      <div className="heading flex flex-col items-center text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold mb-4">
          <span className="bg-linear-to-r from-[#1FAF9A] to-[#1abc9c] bg-clip-text text-transparent">
            A Smarter Way
          </span>
          <br />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-8 my-12">
        {features.map((feature) => {
          ...
          return (
            <div
              key={feature.id}
              className="feature-card p-6 shadow-lg rounded-xl border border-transparent hover:border-green-700 transition duration-300"
            >
